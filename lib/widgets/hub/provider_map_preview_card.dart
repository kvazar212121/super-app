...
class ProviderMapPreviewCard extends StatelessWidget {
                  ...
                  child: Stack(
                    ...
                    children: [
                      if (cover != null && cover.isNotEmpty)
                        CachedNetworkImage(
                          imageUrl: AppConfig.formatImageUrl(cover),
                          fit: BoxFit.cover,
                        ...
                        _fallback(),
                      // Ro'yxat qatoridagi kabi — o'ngga qarab fonga singiydi.
                      DecoratedBox(
  ...
  Widget _fallback() => ColoredBox(
        ...
        child: Center(child: Icon(entry.icon, color: accent, size: 28)),
      );
