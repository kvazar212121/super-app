    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: NetworkImage(venue.gallery.isNotEmpty ? venue.gallery.first : 'https://via.placeholder.com/600x400'),
          fit: BoxFit.cover,
        ),
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _InfoChip(icon: Icons.groups, label: '${venue.maxGuests} kishigacha', color: Colors.blueAccent),
              _InfoChip(icon: Icons.location_city, label: venue.venueType, color: Colors.pinkAccent),
            ],
          ),
          const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Center(
            child: Icon(Icons.celebration, size: 80, color: accent.withOpacity(0.3)),
          ),
          Positioned(
            bottom: 16,
            left: 16,
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: team.organizerTypes.map((type) => 
              _InfoChip(icon: type.icon, label: type.label, color: Colors.deepPurple)
            ).toList(),
          ),
        ],
      ),
