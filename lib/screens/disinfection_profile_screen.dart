...
class DisinfectionProfileScreen extends StatelessWidget {
  ...
  const DisinfectionProfileScreen({super.key, required this.service});
    ...
    return GlassScaffold(
      ...
      body: ListView(
        ...
        children: [
            ...
            child: Column(
              children: [
                CircleAvatar(
                  ...
                  child: const Icon(LucideIcons.shieldCheck, color: accent, size: 40),
                ),
                ...
                Text(
                  service.subCategory ?? 'Dezinfeksiya va deratizatsiya',
          ...
          const SizedBox(height: 16),
          if (service.areaTypes.isNotEmpty) ...[
            Text(
              'Qanday obyektlarda xizmat ko\'rsatadi?',
              style: TextStyle(
            ...
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: service.areaTypes.map((t) => Chip(
          ...
          if (service.chemicals.isNotEmpty) ...[
            Text(
              'Kimyoviy vositalar',
              style: TextStyle(
                fontWeight: FontWeight.bold,
            ...
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: service.chemicals.map((c) => Chip(
                ...
                child: FilledButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => DisinfectionDispatchScreen(service: service),
                      ),
                    );
                  },
                  icon: const Icon(LucideIcons.shieldAlert),
                  label: const Text('Obyektga chaqirish'),
