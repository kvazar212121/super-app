      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DetailRow(
              label: "Tibbiy xizmat",
              value: _selectedMedicalService!.label,
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  final hour =
                      int.tryParse(_selectedTimeSlot!.split(':')[0]) ?? 8;
                  final minute =
                  ...
                  final order = ServiceOrder(
                    ...
                    serviceName:
                        '${widget.service.name} — ${_selectedMedicalService!.label}',
