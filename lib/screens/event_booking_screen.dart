...
class _EventBookingScreenState extends State<EventBookingScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildEventTypeGrid(accentColor),
                  const SizedBox(height: 24),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 4),
            Text(
              "Maks: ${widget.service.maxGuests} mehmon",
              style: TextStyle(color: Colors.grey[600], fontSize: 14),
            ),
          ],
        ),
  ...
  Widget _buildEventTypeGrid(Color color) {
    final availableTypes = widget.service.eventTypes;
  ...
  Widget _buildGuestCountInput() {
    return TextField(
      ...
      decoration: InputDecoration(
        hintText: "Mehmonlar sonini kiriting",
        prefixIcon: Icon(LucideIcons.users, color: Colors.grey[400]),
        suffixText: "kishi",
  ...
  Widget _buildDescriptionInput() {
    return TextField(
      ...
      maxLines: 3,
      decoration: InputDecoration(
        hintText: "Tadbir haqida qo'shimcha ma'lumot...",
  ...
  Widget _buildActionButtons(Color color, NumberFormat currencyFormat) {
    final bool canBook = _selectedEventType != null &&
      ...
      children: [
        ...
        SizedBox(
          ...
          child: OutlinedButton.icon(
            ...
            label: const Text("Tadbir bilan bog'lanish"),
