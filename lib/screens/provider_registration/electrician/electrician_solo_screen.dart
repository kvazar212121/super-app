...
import '../../../services/electrician_portal_service.dart';
...
class ElectricianSoloScreen extends StatefulWidget {
  const ElectricianSoloScreen({super.key});

  @override
  State<ElectricianSoloScreen> createState() => _ElectricianSoloScreenState();
}

class _ElectricianSoloScreenState extends State<ElectricianSoloScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await ElectricianPortalService().registerSolo(
        name: name,
        phone: phone,
        serviceArea: area,
      );
