...
class DisinfectionPendingScreen extends StatefulWidget {
  ...
  const DisinfectionPendingScreen({super.key, required this.providerName});

  @override
  State<DisinfectionPendingScreen> createState() =>
      _DisinfectionPendingScreenState();
}

class _DisinfectionPendingScreenState extends State<DisinfectionPendingScreen> {
