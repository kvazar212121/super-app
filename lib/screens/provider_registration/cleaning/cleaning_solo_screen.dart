...
class CleaningSoloScreen extends StatefulWidget {
  ...
  @override
  State<CleaningSoloScreen> createState() => _CleaningSoloScreenState();
}

class _CleaningSoloScreenState extends State<CleaningSoloScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await CleaningPortalService().registerSolo(
        name: name,
        phone: phone,
        serviceArea: area,
      );
