...
import '../../../services/plumber_portal_service.dart';
...
class PlumberSoloScreen extends StatefulWidget {
  const PlumberSoloScreen({super.key});

  @override
  State<PlumberSoloScreen> createState() => _PlumberSoloScreenState();
}

class _PlumberSoloScreenState extends State<PlumberSoloScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await PlumberPortalService().registerSolo(
        name: name,
        phone: phone,
        serviceArea: area,
      );
  ...
  Widget build(BuildContext context) {
    return ProviderTheme(
      child: Scaffold(
        appBar: AppBar(title: const Text('Santexnik sifatida')),
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Santexnik xizmati odatda yakka usta sifatida ko\'rsatiladi — mijoz manziliga borasiz.',
