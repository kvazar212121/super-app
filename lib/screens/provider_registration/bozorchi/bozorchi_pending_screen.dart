...
import '../../../services/bozorchi_portal_service.dart';

class BozorchiPendingScreen extends StatefulWidget {
  final String providerName;

  const BozorchiPendingScreen({super.key, required this.providerName});

  @override
  State<BozorchiPendingScreen> createState() => _BozorchiPendingScreenState();
}

class _BozorchiPendingScreenState extends State<BozorchiPendingScreen> {
  final _portal = BozorchiPortalService();
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (_) => UnifiedProviderDashboardScreen(
              config: ProviderCategoryConfig.bozorchi,
            ),
          ),
        );
        return;
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(LucideIcons.shoppingCart, size: 48, color: Colors.white),
                ),
