...
class MassagePendingScreen extends StatefulWidget {
  final String providerName;

  const MassagePendingScreen({super.key, required this.providerName});

  @override
  State<MassagePendingScreen> createState() => _MassagePendingScreenState();
}

class _MassagePendingScreenState extends State<MassagePendingScreen> {
  ...
  Future<void> _checkStatus() async {
    ...
    try {
      final data = await _portal.getMe('massajHijoma');
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(LucideIcons.heartPulse, size: 48, color: accent),
                ),
