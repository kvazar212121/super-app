...
class DentalPendingScreen extends StatefulWidget {
  ...
  const DentalPendingScreen({super.key, required this.providerName});

  @override
  State<DentalPendingScreen> createState() => _DentalPendingScreenState();
}

class _DentalPendingScreenState extends State<DentalPendingScreen> {
  ...
  Future<void> _checkStatus() async {
    ...
    try {
      final data = await _portal.getMe('stomatologiya');
