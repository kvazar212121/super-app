...
class EventPendingScreen extends StatefulWidget {
  ...
  const EventPendingScreen({super.key, required this.providerName});

  @override
  State<EventPendingScreen> createState() => _EventPendingScreenState();
}

class _EventPendingScreenState extends State<EventPendingScreen> {
              ...
              children: [
                ...
                Text(
                  widget.providerName.isNotEmpty
                      ? '${widget.providerName} — guruh profilingiz tekshirilmoqda.'
                      : 'Guruh profilingiz tekshirilmoqda.',
                  textAlign: TextAlign.center,
                  style: TextStyle(color: LuxTokens.textMuted, height: 1.45),
                ),
                const SizedBox(height: 8),
                Text('Tasdiqlangandan keyin mijozlar sahna, ovoz va to\'liq tadbir uchun buyurtma beradi.'.tr,
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 13,
