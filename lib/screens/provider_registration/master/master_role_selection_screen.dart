    ...
    return ProviderTheme(
      child: Builder(
        builder: (context) {
          ...
          return Scaffold(
            appBar: AppBar(title: const Text('Usta sifatida')),
            body: ListView(
              ...
              children: [
                ...
                _RoleCard(
                  ...
                  title: 'Yakka usta',
                  subtitle: 'O\'zingiz mijoz manziliga borasiz — kichik ta\'mirlash ishlar',
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    subtitle,
                    style: TextStyle(color: Colors.grey[600], height: 1.35, fontSize: 13),
                  ),
                ],
              ),
            ),
