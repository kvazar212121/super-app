...
class AutoHelpReportsWidget extends StatefulWidget {
  ...
  @override
  State<AutoHelpReportsWidget> createState() => _AutoHelpReportsWidgetState();
}

class _AutoHelpReportsWidgetState extends State<AutoHelpReportsWidget> with SingleTickerProviderStateMixin {
  ...
  Widget _buildServiceReportList(ThemeData theme) {
    final assistanceIcons = {
      ...
      "Yo'l ustasi": LucideIcons.wrench,
    };

    final items = [
      {'service': 'Evakuator', 'count': '18', 'amount': '9 500 000'},
      {'service': 'Benzin yetkazish', 'count': '12', 'amount': '2 400 000'},
      {'service': 'Akkumulyator', 'count': '8', 'amount': '3 200 000'},
      {'service': "Shinpo'la", 'count': '10', 'amount': '2 800 000'},
      {'service': "Yo'l ustasi", 'count': '6', 'amount': '1 800 000'},
    ];
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(
                  assistanceIcons[item['service']] ?? LucideIcons.car,
                  size: 20,
                  color: const Color(0xFFEA580C),
                ),
              ),
