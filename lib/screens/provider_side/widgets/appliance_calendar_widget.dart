...
class ApplianceCalendarWidget extends StatefulWidget {
  const ApplianceCalendarWidget({super.key});

  @override
  State<ApplianceCalendarWidget> createState() => _ApplianceCalendarWidgetState();
}

class _ApplianceCalendarWidgetState extends State<ApplianceCalendarWidget> {
  ...
  Widget _buildDateHeader(ThemeData theme) {
    return Row(
      children: [
        ...
        const Spacer(),
        IconButton(
          icon: const Icon(LucideIcons.calendarDays, color: Color(0xFF607D8B)),
          onPressed: () async {
  ...
  Widget _buildLegend(ThemeData theme) {
    return Row(
      children: [
        ...
        _buildLegendItem('Bajarilmoqda', const Color(0xFF607D8B)),
        const SizedBox(width: 12),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final statusColors = {
          ...
          'Bajarilmoqda': const Color(0xFF607D8B),
          'Rejalashtirilgan': const Color(0xFF6366F1),
        };

        final warrantyColors = {
          'Kafolatda': const Color(0xFF10B981),
          'Chiqqan': const Color(0xFFF59E0B),
        };
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isBooked
                  ? const Color(0xFF607D8B).withValues(alpha: 0.3)
                  : Colors.grey.withValues(alpha: 0.2),
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                decoration: BoxDecoration(
                                  color: (warrantyColors[job!['warranty']] ?? Colors.grey)
