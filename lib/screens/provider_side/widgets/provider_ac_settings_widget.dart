...
/// Konditsioner — xizmatlar, narxlar, vaqt slotlari.
class ProviderAcSettingsWidget extends StatefulWidget {
  final String categoryKey;
  final Color accent;

  const ProviderAcSettingsWidget({
    super.key,
  ...
  @override
  State<ProviderAcSettingsWidget> createState() => _ProviderAcSettingsWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text('Montaj, profilaktika, gaz quyish va boshqa ishlar', style: TextStyle(color: Colors.grey[600])),
