...
class _CourierReportsWidgetState extends State<CourierReportsWidget> with SingleTickerProviderStateMixin {
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TabBarView(
            controller: _tabController,
            children: [
              _buildReportContent('Bugun', '320 000', [40, 70, 50, 90, 60, 80, 30], theme),
              _buildReportContent('Shu oy', '8 750 000', [60, 40, 80, 50, 70, 90, 60], theme),
              _buildReportContent('Shu yil', '95 200 000', [70, 90, 50, 80, 60, 40, 70], theme),
            ],
          ),
        ),
      ],
  ...
  Widget _buildReportList(ThemeData theme) {
    final items = [
      {'title': 'Hujjat (18 ta)', 'amount': '90 000', 'icon': LucideIcons.fileText},
      {'title': 'Sovg\'a (12 ta)', 'amount': '120 000', 'icon': LucideIcons.gift},
      {'title': 'Kichik yuk (8 ta)', 'amount': '80 000', 'icon': LucideIcons.package},
      {'title': 'Katta yuk (3 ta)', 'amount': '60 000', 'icon': LucideIcons.truck},
    ];
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(item['icon'] as IconData, size: 20, color: const Color(0xFFFFB300)),
              ),
