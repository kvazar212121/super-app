...
/// Mobil avto-yordam — xizmatlar, narxlar, vaqt slotlari.
class ProviderAutoSettingsWidget extends StatefulWidget {
  final String categoryKey;
  final Color accent;

  const ProviderAutoSettingsWidget({
    super.key,
  ...
  @override
  State<ProviderAutoSettingsWidget> createState() => _ProviderAutoSettingsWidgetState();
}

class _ProviderAutoSettingsWidgetState extends State<ProviderAutoSettingsWidget> {
  ...
  void _applyMeta(Map<String, dynamic> meta) {
    ...
    if (_services.isEmpty) {
      _addService('Evakuator', '250000');
      _addService('Joyida ta\'mirlash', '150000');
      _addService('Benzin yetkazish (AI-92, 10L)', '120000');
    } else {
