...
class AutoHelpCalendarWidget extends StatefulWidget {
  const AutoHelpCalendarWidget({super.key});

  @override
  State<AutoHelpCalendarWidget> createState() => _AutoHelpCalendarWidgetState();
}

class _AutoHelpCalendarWidgetState extends State<AutoHelpCalendarWidget> {
  ...
  Widget _buildDateHeader(ThemeData theme) {
    return Row(
      children: [
        ...
        const Spacer(),
        IconButton(
          icon: const Icon(LucideIcons.calendarDays, color: Color(0xFFEA580C)),
          onPressed: () async {
          ...
          return InkWell(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isSelected ? const Color(0xFFEA580C) : theme.colorScheme.surface,
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                  color: isSelected ? const Color(0xFFEA580C) : Colors.grey.withValues(alpha: 0.2),
                ),
  ...
  Widget _buildLegend(ThemeData theme) {
    return Row(
      children: [
        ...
        _buildLegendItem('Band', const Color(0xFFEA580C).withValues(alpha: 0.1), const Color(0xFFEA580C)),
      ],
    );
  }
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final statusColors = {
          ...
          'Bajarilmoqda': const Color(0xFFEA580C),
          'Rejalashtirilgan': const Color(0xFF6366F1),
        };

        final assistanceIcons = {
          'Evakuator': LucideIcons.truck,
          'Benzin yetkazish': LucideIcons.fuel,
          'Akkumulyator': LucideIcons.car,
          "Shinpo'la": LucideIcons.circleDot,
        };
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Icon(
                                assistanceIcons[job!['service']] ?? LucideIcons.car,
                                size: 14,
                          ...
                          Row(
                            children: [
                              const Icon(LucideIcons.car, size: 14, color: Colors.grey),
