...
/// Elektrik — xizmatlar, narxlar, vaqt slotlari.
class ProviderElectricianSettingsWidget extends StatefulWidget {
  final String categoryKey;
  final Color accent;

  const ProviderElectricianSettingsWidget({
    super.key,
  ...
  @override
  State<ProviderElectricianSettingsWidget> createState() =>
      _ProviderElectricianSettingsWidgetState();
}

class _ProviderElectricianSettingsWidgetState
    extends State<ProviderElectricianSettingsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          'Rozetka, simlash, shoshilinch chaqiruv va boshqa ishlar',
