...
/// Usta chaqirish — xizmatlar, narxlar, vaqt slotlari; brigada uchun hajm.
class ProviderMasterSettingsWidget extends StatefulWidget {
  final String categoryKey;
  final Color accent;

  const ProviderMasterSettingsWidget({
    super.key,
  ...
  @override
  State<ProviderMasterSettingsWidget> createState() =>
