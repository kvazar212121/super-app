...
class CleaningCalendarWidget extends StatefulWidget {
  const CleaningCalendarWidget({super.key});

  @override
  State<CleaningCalendarWidget> createState() => _CleaningCalendarWidgetState();
}

class _CleaningCalendarWidgetState extends State<CleaningCalendarWidget> {
  ...
  Widget _buildDateHeader(ThemeData theme) {
    return Row(
      children: [
        ...
        const Spacer(),
        IconButton(
          icon: const Icon(LucideIcons.calendarDays, color: Color(0xFF06B6D4)),
          onPressed: () async {
          ...
          return InkWell(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isSelected ? const Color(0xFF06B6D4) : theme.colorScheme.surface,
                borderRadius: BorderRadius.circular(16),
                border: Border.all(
                  color: isSelected ? const Color(0xFF06B6D4) : Colors.grey.withValues(alpha: 0.2),
                ),
  ...
  Widget _buildLegend(ThemeData theme) {
    return Row(
      children: [
        ...
        _buildLegendItem('Bajarilmoqda', const Color(0xFF06B6D4)),
        const SizedBox(width: 12),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final statusColors = {
          ...
          'Bajarilmoqda': const Color(0xFF06B6D4),
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                decoration: BoxDecoration(
                                  color: (job!['material'] == 'O\'z materiali'
