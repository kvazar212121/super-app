...
/// Santexnik — xizmatlar, narxlar, vaqt slotlari.
class ProviderPlumberSettingsWidget extends StatefulWidget {
  final String categoryKey;
  final Color accent;

  const ProviderPlumberSettingsWidget({
    super.key,
  ...
  @override
  State<ProviderPlumberSettingsWidget> createState() =>
      _ProviderPlumberSettingsWidgetState();
}

class _ProviderPlumberSettingsWidgetState extends State<ProviderPlumberSettingsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text('Smesitel, quvur, toshma va shoshilinch chaqiruv', style: TextStyle(color: Colors.grey[600])),
