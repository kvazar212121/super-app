...
class DisinfectionCalendarWidget extends StatefulWidget {
  const DisinfectionCalendarWidget({super.key});

  @override
  State<DisinfectionCalendarWidget> createState() => _DisinfectionCalendarWidgetState();
}

class _DisinfectionCalendarWidgetState extends State<DisinfectionCalendarWidget> {
  ...
  final Map<String, Map<String, String>> _schedule = {
    ...
    '10:30': {
      ...
      'areaType': 'Ofis',
      'area': '120 m²',
      'chemical': 'Vodorod peroksid',
      'safety': 'Standart',
    },
    '14:00': {
      'service': 'Maktab dezinfeksiya',
      'address': 'Sergeli',
      'status': 'Bajarilmoqda',
      'areaType': 'Maktab/bog\'cha',
      'area': '200 m²',
      'chemical': 'Antiseptik sprey',
      'safety': 'Maxsus',
    },
    '16:00': {
  ...
  Widget _buildLegend(ThemeData theme) {
    return Row(
      children: [
        ...
        _buildLegendItem('Bajarilmoqda', const Color(0xFF10B981)),
        const SizedBox(width: 12),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final statusColors = {
          ...
          'Bajarilmoqda': const Color(0xFF10B981),
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                decoration: BoxDecoration(
                                  color: (safetyColors[job!['safety']] ?? Colors.grey).withValues(alpha: 0.15),
                                  borderRadius: BorderRadius.circular(4),
                                ),
                                child: Text(
                                  job!['safety']!,
                                  style: TextStyle(
                                    color: safetyColors[job!['safety']] ?? Colors.grey,
                                    fontSize: 10,
                                    fontWeight: FontWeight.w500,
                                  ),
                                ),
