...
for i in range(len(markers) - 1):
    ...
    if start_idx != -1 and end_idx != -1:
        ...
        # Next marker not found, let's just search the next valid marker
...
for name, code in blocks.items():
    ...
    # Also we have some variables that need to be global:
    # Let's export 'let ...' or 'const ...' at top level of the block?
    # No, it's safer to just attach funcs. The variables will be scoped to the module.
...
# Add API BASE to window in main just in case
